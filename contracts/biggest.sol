...
contract SVGNFT is ERC721URIStorage, Ownable {
    ...
    function addRandomIndex() public {
        randomIndex.push([1,1,1,1]);
    }
    ...
    function createRect() public view returns (string memory){   
        ...
        string memory chunk;
        uint256[][] memory rectBody = body[randomIndex[tokenCounter][0]];
        uint256[][] memory rectHead = head[randomIndex[tokenCounter][1]];
        uint256[][] memory rectAccessory = accessory[randomIndex[tokenCounter][2]];
        uint256[][] memory rectGlasses = glasses[randomIndex[tokenCounter][3]];
